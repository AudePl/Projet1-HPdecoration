...
<section>
    ...
    <h1 class="presentation_title">Nos réalisations</h1>
    <p class="padding_left_small, presentation-paragraph">HP Décoration réalise sur mesure des conceptions design ou traditionnelles répondant à
        vos aspirations tout en
        optimisant l’espace dédié. Des réalisations pratiques, fonctionnelles, ergonomiques et esthétiques utilisant les
        matériaux les plus nobles. N’hésitez pas à nous solliciter ou passer nous voir directement au showroom.</p>
    </div>
    <ul class="prestation-items">
        <li class="menuItems"><a class="prestation-link" href="#cuisines">Cuisines</a></li>
        <li class="menuItems"><a class="prestation-link" href="#salles-de-bain">Salles de bain</a></li>
        <li class="menuItems"><a class="prestation-link" href="#chambres">Chambres</a></li>
    </ul>
</section>
    <!------------------- Cuisines -------------------->
<section>
